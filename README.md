...
- ✅ **Auto-seed admin account** - Tự động tạo tài khoản admin khi khởi động lần đầu
...
📖 Chi tiết về data seeding: Xem [SEEDING.md](./SEEDING.md)
